    ...
    //https://free.currconv.com/api/v7/convert?q=USD_PHP&compact=ultra&apiKey=7c8538d599cfd36ffb92
    class  Conversor extends Component{
       ...
       async converter(){
            // para passar parametros tipo uma nova moeda (exemplo : BRL PARA EURO)!!
            let de_para = this.state.moedaA + '_' + this.state.moedaB;
            // nessa aqui vem como objeto 
            const response = await api.get(`convert?q=${de_para}&compact=ultra&apiKey=7c8538d599cfd36ffb92`)
            //agora so vem numero tipo doble
